...
export const DEFAULT_LABEL_FONT_SIZE_RATIO = 0.04;
export const DEFAULT_HEADLINE_FONT_SIZE_RATIO = 0.092;

export const FONT_OPTIONS = [
  {
    id: "system",
    name: "System Sans",
    stack: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", "Segoe UI", sans-serif',
  },
  {
    id: "sf-pro",
    name: "SF Pro Display",
    stack: '"SF Pro Display", "SF Pro Text", -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif',
  },
  {
    id: "inter",
    name: "Inter",
  ...
  },
  {
    id: "montserrat",
    name: "Montserrat",
    stack: 'Montserrat, "Avenir Next", "Helvetica Neue", Arial, sans-serif',
  },
  {
    id: "poppins",
    name: "Poppins",
  ...
  },
  {
    ...
    stack: '"Arial Rounded MT Bold", "Avenir Next Rounded", "Nunito Sans", "SF Pro Rounded", sans-serif',
  },
  {
    id: "korean-sans",
    name: "Korean Sans",
    stack: 'Pretendard, "Apple SD Gothic Neo", "Noto Sans KR", "Noto Sans CJK KR", "Malgun Gothic", sans-serif',
  },
  {
    id: "korean-display",
    name: "Korean Display",
    stack: '"SF Pro Display", Pretendard, "Apple SD Gothic Neo", "Noto Sans KR", "Malgun Gothic", sans-serif',
  },
  {
    id: "japanese-sans",
    name: "Japanese Sans",
    stack: '"Hiragino Sans", "Hiragino Kaku Gothic ProN", "Yu Gothic", "Noto Sans JP", "Noto Sans CJK JP", sans-serif',
  },
  {
    id: "chinese-simplified",
    name: "Chinese Simplified",
    stack: '"PingFang SC", "Noto Sans SC", "Noto Sans CJK SC", "Microsoft YaHei", sans-serif',
  },
  {
    id: "chinese-traditional",
    name: "Chinese Traditional",
    stack: '"PingFang TC", "Noto Sans TC", "Noto Sans CJK TC", "Microsoft JhengHei", sans-serif',
  },
  {
    id: "devanagari",
    name: "Hindi / Devanagari",
    stack: '"Noto Sans Devanagari", Mukta, "Kohinoor Devanagari", "Mangal", sans-serif',
  },
  {
    id: "display",
    name: "Display",
    stack: '"Avenir Next", "SF Pro Display", "Helvetica Neue", Arial, sans-serif',
  },
  {
    id: "rounded",
    name: "Rounded",
    stack: '"Arial Rounded MT Bold", "Avenir Next Rounded", "Nunito Sans", "Apple SD Gothic Neo", sans-serif',
  },
  {
    id: "editorial",
    name: "Editorial Serif",
    stack: '"New York", "Iowan Old Style", Georgia, "Times New Roman", "AppleMyungjo", serif',
  },
  {
    id: "mono",
    name: "Mono",
...
export function fontById(fontId: string | undefined) {
  return FONT_OPTIONS.find((font) => font.id === fontId) || FONT_OPTIONS[0];
}

export function fontStack(fontId: string | undefined) {
  return fontById(fontId).stack;
}
